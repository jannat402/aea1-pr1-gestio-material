...
public class CCuenta {
	...
	private static final String errorIngresar = "No se puede ingresar una cantidad negativa";
	private static final String errorCantidad = "No se puede retirar una cantidad negativa";
	private static final String errorSaldo = "No se hay suficiente saldo";
	...
	public void ingresar(double cantidad) throws Exception {
		if (cantidad < 0){
			throw new Exception(errorIngresar);
		}
	...
	public void retirar (double cantidad) throws Exception {
		if (cantidad < 0){
			throw new Exception (errorCantidad);
		}
